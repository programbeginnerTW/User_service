...
class PaymentTest extends DatabaseTestCase
{
    ...
    public function testList()
    {
        ...
        $resNotHasdataResults = $this->withBodyFormat('json')->withHeaders($notExistUserHeaders)
                                                             ->get("api/v1/payments
                                                                    ?limit={$resNotHasdata["limit"]}
                                                                    &search={$resNotHasdata["search"]}
                                                                    &offset={$resNotHasdata["offset"]}
                                                                    &isDesc={$resNotHasdata["isDesc"]}");
        ...
        $hasParamdataResults = $this->withBodyFormat('json')->withHeaders($headers)
                                                            ->get("api/v1/payments
                                                                    ?limit={$hasParamdata["limit"]}
                                                                    &search={$hasParamdata["search"]}
                                                                    &offset={$hasParamdata["offset"]}
                                                                    &isDesc={$hasParamdata["isDesc"]}");
        ...
        $testResult = $testQuery->where('u_key', $headers['X-User-key'])
        ...
        $notHasParamdataResults = $this->withBodyFormat('json')->withHeaders($headers)->get('api/v1/payments');
    ...
    public function testShow()
    {
        ...
        $notHasPkeyResults = $this->withBodyFormat('json')->withHeaders($headers)
                                                          ->get('api/v1/payments');
        ...
        $notPaymentResults = $this->withBodyFormat('json')->withHeaders($headers)->get('api/v1/payments/'. $notExistPkey);
        ...
        $successResults = $this->withBodyFormat('json')->withHeaders($headers)->get('api/v1/payments/' . $existPkey);
        ...
        $testQuery = $this->db->table('payment')
            ...
            ->where('p_key', $existPkey)
            ->where('u_key', $headers['X-User-key'])
            ->get()
            ->getResult();
    ...
    public function testCreate()
    {
        ...
        $dataNotExistDataResults = $this->withBodyFormat('json')->withHeaders($headers)->post('api/v1/payments');
        ...
        $paymentExistResults = $this->withBodyFormat('json')->withHeaders($headers)->post('api/v1/payments', $paymentExistData);
        ...
        $amountInsufficientResults = $this->withBodyFormat('json')->withHeaders($headers)->post('api/v1/payments', $amountInsufficientData);
        ...
        $successResults = $this->withBodyFormat('json')->withHeaders($headers)->post('api/vDtm/payments', $successData);
    ...
    public function testUpdate()
    {
        ...
        $dataNotExistResults = $this->withBodyFormat('json')->withHeaders($headers)->put('api/v1/payments');
        ...
        $notPaymentResults = $this->withBodyFormat('json')->withHeaders($notExistUserHeaders)->put('api/v1/payments', $notPaymentData);
        $notPaymentResults->assertStatus(404);
        ...
        $successResults = $this->withBodyFormat('json')->withHeaders($headers)->put('api/v1/payments', $successData);
        if ($successResults->getStatus() == 400) {
            $successDataResultsGetMsgError = json_decode($successResults->getJSON())->messages->error;
    ...
    public function testDelete()
    {
        ...
        $dataNotExistResults = $this->withBodyFormat('json')->withHeaders($headers)->delete('api/v1/payments');
        ...
        $notPaymentResults = $this->withBodyFormat('json')->withHeaders($headers)->delete('api/v1/payments', $notPaymentData);
        $notPaymentResults->assertStatus(404);
        ...
        $successResults = $this->withBodyFormat('json')->withHeaders($headers)->delete('api/v1/payments', $successData);
        if ($successResults->getStatus() == 400) {
            $successDataResultsGetMsgError = json_decode($successResults->getJSON())->messages->error;
            ...
            $successResults->assertStatus(200);
            //確認資料已刪除
            $deleteCheckResult = $this->grabFromDatabase('payment', 'deleted_at', ['p_key' => $successData['p_key'], 'u_key' => $headers['X-User-key']]);
